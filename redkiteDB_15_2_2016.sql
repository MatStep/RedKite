...
INSERT INTO `attribute` (`id`) VALUES
(11),
(12);
...
CREATE TABLE `attribute_lang` (
  ...
  KEY `lang_id` (`lang_id`),
  CONSTRAINT `attribute_lang_ibfk_1` FOREIGN KEY (`attribute_id`) REFERENCES `attribute` (`id`),
  CONSTRAINT `attribute_lang_ibfk_2` FOREIGN KEY (`lang_id`) REFERENCES `lang` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `attribute_lang` (`id`, `attribute_id`, `lang_id`, `name`) VALUES
(21,	11,	1,	'kusy'),
(22,	11,	2,	'kusy'),
(23,	12,	1,	'farby'),
(24,	12,	2,	'farby');
...
INSERT INTO `attribute_value` (`id`, `attribute_id`, `from`, `to`) VALUES
(2,	11,	0,	0),
(3,	11,	0,	0),
(4,	11,	0,	0),
(5,	12,	0,	0),
...
DROP TABLE IF EXISTS `attribute_value_lang`;
CREATE TABLE `attribute_value_lang` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `lang_id` (`lang_id`),
  CONSTRAINT `attribute_value_lang_ibfk_1` FOREIGN KEY (`attribute_value_id`) REFERENCES `attribute_value` (`id`),
  CONSTRAINT `attribute_value_lang_ibfk_2` FOREIGN KEY (`lang_id`) REFERENCES `lang` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `attribute_value_lang` (`id`, `attribute_value_id`, `lang_id`, `name`) VALUES
(1,	2,	1,	'1-24 ks'),
(2,	2,	2,	'1-24 ks'),
(3,	3,	1,	'25-50 ks'),
(4,	3,	2,	'25-50 ks'),
...
(58,	NULL,	'b1',	1,	0,	'2016-02-05 16:42:42',	10),
(59,	NULL,	'b2',	1,	0,	'2016-02-05 16:42:42',	5);
...
(46,	58,	1,	'tričko farebne',	'kratka',	'dlha'),
(47,	58,	2,	'tričko farebne',	'kratka',	'dlha'),
(48,	59,	1,	'tricko biele',	'kratkadesc',	'dlhadesc'),
(49,	59,	2,	'tricko biele',	'kratkadesc',	'dlhadesc');
...
CREATE TABLE `service` (
  ...
  PRIMARY KEY (`id`),
  KEY `attribute_id1` (`row_id`),
  KEY `attribute_id2` (`col_id`),
  CONSTRAINT `service_ibfk_1` FOREIGN KEY (`row_id`) REFERENCES `attribute` (`id`),
  CONSTRAINT `service_ibfk_2` FOREIGN KEY (`col_id`) REFERENCES `attribute` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `service` (`id`, `row_id`, `col_id`, `img_path`) VALUES
(4,	11,	12,	'');

DROP TABLE IF EXISTS `service_attribute_value`;
CREATE TABLE `service_attribute_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `attribute_value_id1` int(11) NOT NULL,
  `attribute_value_id2` int(11) NOT NULL,
  `price_sell` double NOT NULL,
  `price_buy` double NOT NULL,
  PRIMARY KEY (`id`),
  KEY `attribute_value_id1` (`attribute_value_id1`),
  KEY `attribute_value_id2` (`attribute_value_id2`),
  CONSTRAINT `service_attribute_value_ibfk_1` FOREIGN KEY (`attribute_value_id1`) REFERENCES `attribute_value` (`id`),
  CONSTRAINT `service_attribute_value_ibfk_2` FOREIGN KEY (`attribute_value_id2`) REFERENCES `attribute_value` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `service_attribute_value` (`id`, `attribute_value_id1`, `attribute_value_id2`, `price_sell`, `price_buy`) VALUES
(6,	2,	5,	1.35,	0),
(7,	2,	6,	1.48,	0),
(8,	3,	5,	1.85,	0);
...
INSERT INTO `service_lang` (`id`, `service_id`, `lang_id`, `name`, `desc`) VALUES
(7,	4,	1,	'Sieťotlač',	''),
(8,	4,	2,	'Sieťotlač',	'');
